...
export const updateProduct = async (req: Request, res: Response) => {
    try {
        ...
        const { id } = req.params as { id: string };
        const { title, description, imageUrl } = req.body as UpdateProductBody;
        ...
        const updated = await queries.updateProduct(id, { title, description, imageUrl });
...
export const deleteProduct = async (req: Request, res: Response) => {
    try {
        ...
        const deleted = await queries.deleteProduct(id);
